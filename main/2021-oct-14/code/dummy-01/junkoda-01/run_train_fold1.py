...
def run_train(
    ...
    initial_checkpoint = \
        out_dir + '/checkpoint/00070000.model.pth'  #
        #'/root/share1/nuh/result/mri-prostate/3dunet-01/fold0/checkpoint/00000880_model.pth'  #
    ...
    write_pickle_to_file(out_dir+'/scaler.pickle',scaler)

    train_idx, valid_idx = make_fold(df, mode='train-1')
    train_dataset = VentilatorDataset(df, train_idx, scaler, )#train_augment
